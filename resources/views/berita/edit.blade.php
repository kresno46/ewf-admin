        ...
        <div class="card-body">
            ...
            <form id="productForm" action="{{ route('berita.update', $berita->id) }}" method="POST"
                ...
                <div class="d-flex">
                    <div class="form-group w-100 mr-1">
                        ...
                        @if ($berita->image)
                            ...
                            <img src="{{ asset('img/berita/' . $berita->image) }}" alt="Gambar Berita" class="mt-2"
                                width="100">
                        @endif
                    ...
                    <div class="form-group w-100 ml-1">
                        ...
                        <select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori"
                            ...
                            <option value="Info & Kegiatan"
                                {{ old('kategori', $berita->kategori) == 'Info & Kegiatan' ? 'selected' : '' }}>
                                Info & Kegiatan</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control tinymce-editor @error('isi') is-invalid @enderror" id="isi" name="isi" rows="8" required>{{ old('isi', $berita->isi) }}</textarea>
                    @error('isi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
