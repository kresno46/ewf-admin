        ...
        <div class="card-body">
            <form id="productForm" action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex">
                    ...
                    <div class="form-group w-100 ml-1">
                        ...
                        <select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori"
                            required>
                            <option value="Info & Kegiatan" {{ old('kategori') == 'Info & Kegiatan' ? 'selected' : '' }}>
                                Info
                                & Kegiatan</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control tinymce-editor @error('isi') is-invalid @enderror" id="isi" name="isi" rows="8" required>{{ old('isi') }}</textarea>
                    @error('isi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
